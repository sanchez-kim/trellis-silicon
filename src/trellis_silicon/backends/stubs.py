...
def install_stubs(stubs_dir):
    ...
    # cumesh
    _write(
        os.path.join(stubs_dir, "cumesh.py"),
        '''\
...
''',
    ...
    _write(
        os.path.join(stubs_dir, "flex_gemm.py"),
        '''\
...
''',
    ...
    _write(
        os.path.join(fg_ops, "grid_sample.py"),
        """\
...
""",
    ...
    _write(
        os.path.join(ov_dir, "rasterize.py"),
        """\
class VoxelRenderer:
